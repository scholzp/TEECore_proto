...
fn setup_offcore() {
	...
	counter.set_offcore_configuration(
		// 0x0_u64
        // | 0x1 << 0  // REQUEST_TYPE DEMAND_DATA_RD
        // | 0x1 << 1  // REQUEST_TYPE DEMAND_DATA_RFO (read for write)
        // | 0x1 << 2  // REQUEST_TYPE DEMAND_IFETCH
        // // No supplier
        // | 0x1 << 34 // SNOOP_HIT_NO_FWD
        // | 0x1 << 35 // SNOOP_HIT_WITH_FWD
        // | 0x1 << 36 // SNOOP_HITM
        0x3F807F8FFF
	);
...
fn setup_architecturial() {
    ...
    let event_mem_retired_any: u64 = 0xd0_u64 | 0x83_u64 << 8;
	let event_l2_hit: u64 = 0xd1_u64 | 0x02_u64 << 8;
	let event_l2_miss: u64 = 0xd1_u64 | 0x10_u64 << 8;
    // let event_l2_miss: u64 = 0x25_u64 | 0x1f_u64 << 8;

	counters[0].set_configuration(event_mem_retired_any | IA32_PERFEVTSEL_OS | IA32_PERFEVTSEL_USR);
...
pub fn read_and_print_pmcs() {
	...
	info!("IA_PMC1 (Mem Inst Any)     = {:#018x?}", counters[0].read_pcm_val());
